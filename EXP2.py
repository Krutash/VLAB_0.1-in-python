...
class Exp2_class(QTabWidget):
    ...
    def __init__(self):
        ...
        self.stockSol_val.setMaximumHeight(30)
        self.stockSol_val.setMinimumHeight(30)
        ...
        for i in [self.Label1, self.stockSol_val, self.Label2, self.IodineTable, self.Label4,
                  self.SolsTab]:
        ...
        #self.meterLabel.setMinimumHeight(420)
        #self.meterLabel.setMaximumHeight(420)
    ...
    def cal_Trial(self):
        ...
        if(self.validateStock()):
            ...
            flask.setPixmap(QPixmap("media/iodine.jpg"))
            self.flasks_count[row-1] = int(time*10)
            self.flasks_count_red[row-1] = int(time*10)
